"""
Baseline inference con medición de latencia por pregunta (H4).
...
output_path       = DATA_DIR / "baseline" / "baseline_latency_results.json"
...
results = []
print(f"\n4. Inferencia baseline con latencia ({N_SAMPLES} preguntas)...")
