"""
Evaluación RAGAS híbrido avanzado GPT v2.
Input:  data/hybrid/advanced/hybrid_advanced_inference_results_v2.json
Output: data/hybrid/advanced/hybrid_advanced_evaluation_gpt_results_v2.csv
"""
import json
import os
import sys
...
output_file = DATA_DIR / "hybrid" / "advanced" / "hybrid_advanced_evaluation_gpt_results_v2.csv"

print("1. Cargando resultados de inferencia hibrida avanzada (v2)...")
...
print(f"4. Iniciando evaluacion RAGAS hibrido avanzado GPT v2 ({len(data)}q x 5 metricas)...")
result = evaluate(dataset=dataset, metrics=metricas, run_config=configuracion)

print("\n" + "=" * 40)
print("RESULTADOS FINALES HIBRIDO AVANZADO v2 (GPT-4o-mini)")
print("=" * 40)
print(result)
