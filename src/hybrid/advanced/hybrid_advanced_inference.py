"""
Híbrido avanzado (S4): EnsembleRetriever (BM25+Chroma) + CrossEncoder reranking + HyDE
...
output_file = DATA_DIR / "hybrid" / "advanced" / "hybrid_advanced_inference_results.json"
