"""
Híbrido avanzado S4 v3: EnsembleRetriever (BM25+Chroma) + CrossEncoder reranking
+ generador fine-tuneado (Llama-3-8B + LoRA). Sin HyDE — retrieval directo.
Test set 14q.
"""
import json
import re
...
output_file = DATA_DIR / "hybrid" / "advanced" / "hybrid_advanced_inference_results_v3.json"
...
results = []
print(f"\n3. Inferencia híbrida avanzada sobre {len(golden_dataset)} preguntas (sin HyDE)...")
