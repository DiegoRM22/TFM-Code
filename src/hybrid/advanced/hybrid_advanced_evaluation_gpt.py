"""
Evaluación RAGAS del pipeline híbrido avanzado con GPT-4o-mini como juez.
Input:  data/hybrid/advanced/hybrid_advanced_inference_results_v2.json
Output: data/hybrid/advanced/hybrid_advanced_evaluation_gpt_results.csv
"""
import json
import os
import sys
...
input_file  = DATA_DIR / "hybrid" / "advanced" / "hybrid_advanced_inference_results_v2.json"
output_file = DATA_DIR / "hybrid" / "advanced" / "hybrid_advanced_evaluation_gpt_results.csv"

print("1. Cargando resultados de inferencia hibrida avanzada...")
...
print(f"4. Iniciando evaluacion RAGAS hibrido avanzado GPT ({len(data)}q x 5 metricas)...")
result = evaluate(dataset=dataset, metrics=metricas, run_config=configuracion)

print("\n" + "=" * 40)
print("RESULTADOS FINALES HIBRIDO AVANZADO (GPT-4o-mini)")
print("=" * 40)
print(result)
