"""
Evaluación RAGAS del pipeline híbrido (RAG + fine-tuning).
Mismas 4 métricas que rag_evaluation.py para comparación directa.
"""
import json
import sys
import pandas as pd
...
output_file = DATA_DIR / "hybrid" / "hybrid_evaluation_results.csv"
...
print("\n" + "=" * 40)
print("RESULTADOS FINALES HÍBRIDO")
print("=" * 40)
print(result)
