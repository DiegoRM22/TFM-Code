...
path_sucia = "./db_rgpd"
path_limpia = "./db_rgpd_pymupdf"

# 2. Conexión a ambas BBDD
...
# 4. Ejecutar la comparación con palabras que sabemos que daban problemas
